...
/**
 * Genera un Data URL SVG de shimmer para usar como blurDataURL en Next/Image.
 * Compatible con SSR y client-side rendering.
 */
export function getShimmerDataURL(w = 700, h = 475): string {
