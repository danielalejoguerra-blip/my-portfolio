// ============================================
// Skills Admin [skill_id] - GET / PUT / DELETE
// ============================================
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await fetch(`${API_URL}/skills/admin/${skill_id}`, {
    ...
    console.error('Skills admin GET by ID error:', error);
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await fetch(`${API_URL}/skills/${skill_id}`, {
      method: 'PUT',
    ...
    console.error('Skills admin PUT error:', error);
    return NextResponse.json({ message: 'Error interno del servidor' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await fetch(`${API_URL}/skills/${skill_id}?hard=${hard}`, {
      method: 'DELETE',
    ...
    console.error('Skills admin DELETE error:', error);
    return NextResponse.json({ message: 'Error interno del servidor' }, { status: 500 });
  }
}
