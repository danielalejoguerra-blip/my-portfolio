// ============================================
// Courses Admin [course_id] - GET / PUT / DELETE
// ============================================
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await fetch(`${API_URL}/courses/admin/${course_id}`, {
    ...
    console.error('Courses admin GET by ID error:', error);
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Courses admin PUT error:', error);
    return NextResponse.json({ message: 'Error interno del servidor' }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const response = await fetch(`${API_URL}/courses/${course_id}?hard=${hard}`, {
      method: 'DELETE',
    ...
    console.error('Courses admin DELETE error:', error);
    return NextResponse.json({ message: 'Error interno del servidor' }, { status: 500 });
  }
}
