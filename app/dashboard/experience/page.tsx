...
export default function ExperiencePage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await experienceService.adminGetAll({
        limit: 100,
        include_hidden: true,
  ...
  const handleDelete = async (id: number, hard = false) => {
    ...
    try { await experienceService.remove(id, hard); await fetchData(); }
          ...
          <Card className="fade-in-up" sx={{ animationDelay: '150ms' }}>
            <CardContent sx={{ py: 10, textAlign: 'center' }}>
              <Box sx={{
                ...
                <WorkRoundedIcon sx={{ fontSize: 36, color: '#fff' }} />
              </Box>
                ...
                >
                  ...
                  {item.images && item.images.length > 0 ? (
                    ...
                    <Box sx={{
                      ...
                      <WorkRoundedIcon sx={{ fontSize: 48, color: 'text.disabled', opacity: 0.5 }} />
                    </Box>
                  )}
            ...
            <Stack spacing={3}>
              ...
              <Stack direction="row" spacing={1} alignItems="flex-end">
                ...
                <TextField
                  ...
                  size="small"
                  sx={{ flex: 1 }}
                  placeholder='Google or ["React","Node.js"]'
                />
